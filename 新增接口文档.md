...
**说明**
获取指定日期-区域里的被占用的场地列表，即返回“场地申请表”中的“已通过”和“审核中”的表项
...
### 5. 取消预约 DELETE `users/booked_ground/?user_id=&apply_id=`
...
**Request**
http://127.0.0.1:8000/users/booked_ground/?user_id=1&apply_id=1
