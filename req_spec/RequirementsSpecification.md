...
| 1.3  | 王肇凯，李永毅                 | 2021.4.5  | 增加了四张图，导出为word并调整格式                           |
| 1.4  | 王肇凯                         | 2021.6.5  | 根据beta版实际设计，删除和修改部分功能                       |
...
#### 3.3.1 普通用户（to update，比如实名认证，场地相关功能）

普通用户具有申请创建组织，申请组织管理员、关注组织、取消关注组织、报名参加活动、退出活动、评论活动、发布个人活动功能。

<img src="RequirementsSpecification.assets/image-20210405031252603.png" alt="image-20210405031252603" style="zoom:50%;" />
...
用户输入北航邮箱，之后会收到一封身份验证的邮件，在邮件中点击确认即可完成身份验证。
...
<img src="RequirementsSpecification.assets/image-20210405031328096.png" alt="image-20210405031328096" style="zoom:50%;" />
...
<img src="RequirementsSpecification.assets/image-20210405031347675.png" alt="image-20210405031347675" style="zoom:50%;" />
...
### 3.4 管理端功能描述（todo 数据可视化，场地管理）

本节所有功能均在web端管理员系统使用。

<img src="RequirementsSpecification.assets/image-20210405031403634.png" alt="image-20210405031403634" style="zoom:50%;" />
...
在组织审核页面，超级管理员可以查看所有创建组织的申请，并选择同意或拒绝申请。
...
## 4 非功能性需求（to update 比如订阅场地的性能需求）
